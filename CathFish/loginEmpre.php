    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="index.php">Entrar como Usúario</a>
          </li>
          <li class="nav-item">
          ...
          <div class="col">
            ...
            <div class="container">
              <div class="row align-items-center">
                <div class="col">
                  <?php
                  if (isset($_SESSION['empresa_nao_autenticado'])) :
                  ?>
                  ...
                  unset($_SESSION['empresa_nao_autenticado']);
                  ?>
                </div>
              </div>
            </div>
          ...
          <div class="row align-items-center">
            <div class="col md-2">
              <div class="card card-body">
                <form method="POST" class="row g-3" action="Vempresa.php">
                  <div class="col-md-6">
